...
import { setUserListSetting, selectPage, setModal,resetListSetting } from '../../redux/actions/UserSettingActions';
...
export default function UserList() {
    ...
    const searchKey = useSelector(state => state.UserReducer.searchKey)
    ...
    const filterRender = (modal) => {
        return <Fragment>
            ...
            <input type="radio" id={"10" + modal} name={"itemperpage" + modal} defaultValue="10" defaultChecked={userListSetting_itemperpage === '10'} />
