...
export default function SubInfo(props) {
    return (
        <div className="row justify-content-around" style={{ height: '35px', margin: '30px 30px 7.5px 30px' }}>
            <div className="col-5 d-flex justify-content-around align-items-center" style={{ border: '.5px solid #645A5333', borderRadius: '20px' }}>
